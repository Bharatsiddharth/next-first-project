  ...
  return (
    <>
      ...
      <section className=''>
        ...
        <div className={`page1 h-screen bg-[#1D1D1F] w-full flex items-center justify-center overflow-hidden ${blinker.className}`}>

          
          <div onClick={CircleScrollClick}
            className="left-arrow relative max-[750px]:hidden  z-50 "

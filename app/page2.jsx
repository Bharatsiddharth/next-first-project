...
<div className="text-white px-20 max-[620px]:px-12 w-full my-20 flex flex-col md:flex-row">
  <div className="w-full md:w-1/2 max-[800px]:py-10 max-[800px]:pt-72 relative">
    ...
    <img className="absolute rotate-12 rounded-xl top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2/3 h-80 max-[800px]:w-full" src="https://images.unsplash.com/photo-1612428978523-a8d7e9e294aa?q=80&w=1780&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
  </div>
  <div className="w-full md:w-1/2 py-32 md:pr-0 ">

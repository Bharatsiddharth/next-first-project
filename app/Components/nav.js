    ...
    <>
      ...
      <nav className="w-full fixed z-[900]">
        <section>
          <div>
            <nav
              className={`nav1 z-[901] ${
                menuOpen
                  ? 'bg-white transition-colors delay-1000 duration-500'
                  : 'bg-[#1D1D1F] transition-colors delay-1000 duration-500'
            ...
            >
              ...
              <div className="">
                ...
                <i
                  className={`menu rounded-full text-white max-[620px]:text-xl bg-[#9d6cff] p-4 text-2xl cursor-pointer ${
                    menuOpen ? 'ri-close-circle-line' : 'ri-menu-line'
                  }`}
                  onClick={toggleMenu}
                ></i>
              </div>
            ...
            <nav
              className={`nav2 absolute z-[99] w-full transition-transform duration-100 ease-in-out ${
            ...
            >
              ...
              <div
                className={`w-full z-[1000] ${
                  menuOpen ? ' h-[70vh]' : ' h-[0] delay-300 duration-500'
